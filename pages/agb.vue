...
<template>
  <div>
    ...
    <p>Für alle Lieferungen von <b></b>
    ...
    an den Verbraucher gelten diese Allgemeinen Geschäftsbedingungen (AGB).</p>
    ...
    <p>Durch das Anklicken der Kaufbestätigung geben Sie eine verbindliche Bestellung der auf der Bestellseite aufgelisteten Waren ab. Ihr Kaufvertrag kommt zustande, wenn wir Ihre Bestellung durch eine Auftragsbestätigung per E-Mail unmittelbar nach dem Erhalt Ihrer Bestellung annehmen. Bitte beachten Sie, dass Sie beim Bestellvorgang dazu verpflichtet sind, eine E-Mail einzugeben, auf die Sie Zugriff haben.</p>
        <a href="#"><input type="submit" name="kaufen" value="kostenpflichtig bestellen" target="_blank"/></a>
    <br><br><br>
    <h2>3. Preise & Verpackung</h2>
    <p>Es gelten die Preise, die zum Zeitpunkt der Bestellung im Angebot aufgeführt sind. Diese sind die Endpreise und enthalten bereits die in Deutschland gesetzlich geltende Mehrwertsteuer. Bei Artikel, für die zum Zeitpunkt des Kaufes im Sonderangebot sind oder für die ein Gutschein eingelöst wurde, ist der reduzierte Preis im endgültigen Angebot der Bestellung enthalten.</p>
    <br>
